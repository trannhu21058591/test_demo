...
function App() {
  ...
  return (
    ...
    <div className='h-screen flex flex-col items-center justify-center'>
      <p className='text-sky-400 text-[30px]'>Cuộc đời</p>
      <p className='text-black text-sm'>thật là</p>
      <p className='text-red-400 text-[50px]'>U là trời</p>
      <button className='h-[40px] w-[100px] bg-slate-300 rounded-3xl'> Ấn tui điiii</button>
    </div>
